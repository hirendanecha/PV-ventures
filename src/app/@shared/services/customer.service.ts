...
export class CustomerService {
  ...
  startCallToBuzzRing(callerData: Object): Observable<any>{
    const url = 'https://ring-dev-api.pussy.ventures/api/customers/call-notification';
    return this.http.post(url, callerData);
  }
  
  startGroupCallToBuzzRing(callerData: Object): Observable<any>{
    const url = 'https://ring-api.pussy.ventures/api/v1/customers/group-call-notification';
    return this.http.post(url, callerData);
  }
}
